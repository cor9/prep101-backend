...
function renderBoldChoicesTemplate(data, meta = {}, isPreview = false) {
  ...
  <div class="prep101-upsell" style="background: var(--ink); border-radius: var(--border-radius); padding: 48px 36px; margin: 48px 0; text-align: center; border: 2px solid var(--gold);">
    ...
    <a href="https://prep101.childactor101.com" target="_blank" style="display: inline-block; background: var(--coral); color: #fff; font-family: 'DM Sans', sans-serif; font-weight: 600; font-size: 15px; padding: 14px 36px; border-radius: 8px; text-decoration: none; letter-spacing: 0.03em; transition: opacity 0.2s;">👉 Build the performance →</a>
  </div>`;
...
<div class="prep101-badge">
  Generated by <strong>Prep101</strong> Bold Choices &nbsp;·&nbsp; boldchoices.childactor101.com
</div>
